...
System.out.println("__________________________________________________");
System.out.println("		Cake	1		15rs                ");
System.out.println("	      Set of Cupcakes  6		15rs	      ");
System.out.println("_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _  __ ");
System.out.println("	Frostings (vanilla,     chocolate,      strawberry,    coco)");
System.out.println("	Fillings (mocha,        mint,              caramel,      raspberry)");
...
System.out.println("Vanille, Chocolate, Strawberry or Coco");
...
System.out.println("Mocha, Mint, Caramel or Raspberry");
...
System.out.printf("The cost of your order is: Rs%.2f\n", cost);
tax = cost * TAX_RATE;
System.out.printf("The tax is: Rs%.2f\n", tax);
System.out.printf("The total due is: Rs%.2f\n",(tax + cost));  
    }   
}